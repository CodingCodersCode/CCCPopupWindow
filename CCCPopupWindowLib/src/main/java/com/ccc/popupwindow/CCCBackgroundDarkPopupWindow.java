...
/**
 * Date：2018/11/27 09:50
 * <p>
 * author: CodingCodersCode
 */
public class CCCBackgroundDarkPopupWindow extends PopupWindow {
    ...
    public CCCBackgroundDarkPopupWindow(View contentView, int width, int height) {
